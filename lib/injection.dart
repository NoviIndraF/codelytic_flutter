...
import 'data/datasource/network/discussion/discussion_remote_data_source_impl.dart';
...
import 'data/repositories/discussion_repositories.dart';
...
import 'domain/repositories/disscussion_repository.dart';
...
import 'domain/usecase/discussion/discussion_usecase.dart';
...
void init(){
  ...
  locator.registerFactory(() => DiscussionBloc(locator()));
  ...
  locator.registerLazySingleton(() => DiscussionUsecase(locator()));
  ...
  locator.registerLazySingleton<DiscussionRepositories>(() => DiscussionRepositoriesImpl(discussionRemoteDataSourceImpl: locator(), sharedPreferencesDataSourceImpl: locator()));
  ...
  // data source
  locator.registerFactory(() => DiscussionRemoteDataSourceImpl(dio: locator(),client: locator()));
